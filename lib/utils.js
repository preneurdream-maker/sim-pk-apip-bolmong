...
export const ROLE_CONFIG = {
  AUDITOR:   { label: "Auditor Pengawasan",        color: "text-blue-600",   nav: ["dashboard","kka"] },
  KETUA_TIM: { label: "Ketua Tim QA",              color: "text-emerald-600",nav: ["dashboard","review"] },
  IRBAN:     { label: "Irban / Dalnis",            color: "text-amber-600",  nav: ["dashboard","review","approval"] },
  INSPEKTUR: { label: "Inspektur Daerah",          color: "text-rose-600",   nav: ["dashboard","review","approval"] },
  ADMIN:     { label: "Administrator Sistem",      color: "text-purple-600", nav: ["dashboard","kka","review","approval","repository","sdm"] },
